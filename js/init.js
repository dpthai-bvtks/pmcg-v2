...
window.dataCacheTime = window.dataCacheTime || {};
        ...
        window.loadTimRanhDataFromServer = function () {
            ...
            let sessionId = '';
            try {
                const session = JSON.parse(localStorage.getItem('meds_session') || '{}');
                sessionId = session.sessionId || '';
            } catch (e) { }
            fetch(typeof API_URL !== 'undefined' ? API_URL : 'https://script.google.com/macros/s/AKfycbx_E9fQlyNYptXab1t_UCiLw3ETA1yTttVB599mp-N339xIzgKMYHQoVilRTs0ZKJGA4A/exec', {
